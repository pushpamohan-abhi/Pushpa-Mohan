...
export const module1Deck: SlideDeck = {
  ...
  "slides": [
    ...
    {
      "id": "dfa-transition-vs-extended-ex",
      "title": "Transition Function (δ) vs. Extended Transition Function (δ̂)",
      "subtitle": "Single Symbol Transitions vs. Complete String Evaluation Example",
      "bullets": [
        "Transition Function (δ): Tells us how the automaton moves from one state to another state for a single input symbol (δ: Q × Σ → Q).",
        "Extended Transition Function (δ̂): Tells us the final state after processing a complete string (zero, one, or many symbols) (δ̂: Q × Σ* → Q).",
        "Concrete Example Setup:",
        "• States: Q = {q₀, q₁}, Alphabet: Σ = {a, b}",
        "• Transition Rules: δ(q₀, a) = q₁, δ(q₀, b) = q₀, δ(q₁, a) = q₀, δ(q₁, b) = q₁",
        "1. Single Symbol Processing (Transition Function δ):",
        "   • δ(q₀, a) = q₁  (Processes ONLY one symbol 'a' from state q₀).",
        "2. Complete String Processing for 'aba' (Extended Transition Function δ̂):",
        "   • Find δ̂(q₀, aba) by processing one symbol at a time:",
        "     - Step 1: δ(q₀, a) = q₁",
        "     - Step 2: δ(q₁, b) = q₁",
        "     - Step 3: δ(q₁, a) = q₀",
        "   • Therefore: δ̂(q₀, aba) = q₀  (Final state after processing string 'aba')."
      ],
      "explanation": "The transition function δ computes a single state transition for one input symbol, whereas the extended transition function δ̂ recursively processes an entire string symbol-by-symbol to determine the final state.",
      "codeSnippet": "δ(q₀, a) = q₁ (1 symbol)  |  δ̂(q₀, aba): Step 1: δ(q₀,a)=q₁ → Step 2: δ(q₁,b)=q₁ → Step 3: δ(q₁,a)=q₀ ⇒ δ̂(q₀, aba) = q₀",
      "dfaExample": {
        "title": "DFA: Transition vs. Extended Transition Example",
        "states": [
          "q0",
          "q1"
        ],
